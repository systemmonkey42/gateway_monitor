...
var FMSRequest = (function() {
    "use strict";

    var FMSRequest = function(opts) {
    };

    util.inherits(FMSRequest,http.ClientRequest);
...
module.exports.FMSRequest = FMSRequest;
